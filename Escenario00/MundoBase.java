...
public abstract class MundoBase extends World {
    ...
    protected boolean[][] posicionesOcupadas;
    /*
     * Declaramos posicionesOcupadas acá porque no se puede incializar en la misión (mundo) en si, ya 
     * que "super", debe ir, si o si, al principio del constructor, y si no se inicializa 
     * posicionesOcupadas antes tira error.
     */
    ...
    public MundoBase(int ancho, int alto, int tamañoCelda) {
        ...
        posicionesOcupadas = new boolean[ancho][alto]; // Se inicializa posicionesOcupadas
