...
public abstract class NaveAliada extends NaveBase {
    ...
    /**
     * PARTE MODIFICADA POR LA ESTRELLA
     */
    
    
    
    /**
     * Permite saber si se se debe traspasar los obstaculos
     */
    public static boolean traspasarObstaculos;
    /**
     ...
     * {@link #obtenerConsumoPorMovimiento()}, recogerá cualquier {@link Item} y {@link Estrella} 
     * que se encuentre en el camino, y se desplazará un casillero en la dirección
     * solicitada.
     * 
    ...
    /**
     * Buscar tanto un Item como una Estrella
     */ 
    Item item = (Item) getOneObjectAtOffset(0, 0, Item.class);
    Estrella estrella = (Estrella) getOneObjectAtOffset(0, 0, Estrella.class);

    /**
     * Si hay un Item, recoger combustible
     */ 
    if (item != null) {
    ...
    /**
     * Si se recoje la Estrella, la nave puede traspasar todos los obstaculos con lo
     * puesto en NaveBase
     */
    if (estrella != null) {
        this.traspasarObstaculos = estrella.serRecogido();
    }
    ...
    /**
     * FIN DE LA PARTE DE NaveAliada MODIFICADO POR Estrella
     */
