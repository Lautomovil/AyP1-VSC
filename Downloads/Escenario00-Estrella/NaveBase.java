...
public abstract class NaveBase extends ActorBase implements Dañable {
    ...
    * 
     ...
     * 
     * 
     * Parte modificada: Si se agarra la Estrella, se activa el boolean de NaveAliada de traspasarAsteroides, haciendo que se pueda mover sin importar el obstaculo que tenga al frente
     */
    protected boolean moverHacia(Direccion direccion) {
        ...
        if (NaveAliada.traspasarObstaculos) {
        move(1);
        return true;
        }
